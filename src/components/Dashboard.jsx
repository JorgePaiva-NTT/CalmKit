...
import { MainDashboardCard, DashboardCard, SimpleDashboardCard } from './Common/DashboardCard.jsx'

export default function Dashboard({ goCoach, goLog, goChat, goHistory }) {
  ...
  return (
    <Stack spacing={2}>
      ...
      <MainDashboardCard goToPageAction={goLog} actionText="Log Emotion"
        title={`How are you feeling${greetingName}?`}
      ...
      <SimpleDashboardCard
        onClick={goHistory}
        title="View Your Log History"
        description="Review past entries and track your emotional trends."
